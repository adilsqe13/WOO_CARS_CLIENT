        ...
        <>
            <section style={{ backgroundColor: "#ffffff" }}>
                <div className="container py-5">
                    <h1 className='mt-3'>My Deals <small className='h6 text-secondary'>&nbsp; &nbsp; {bookings === null ? 0 : bookings.length} - deals</small></h1>
                    <div className="row justify-content-center mb-3 mt-4">

                        <h5 className='text-danger text-align-center dfjcac'>{bookings === null ? '' : bookings.length === 0 ? 'No deals' : ''}</h5>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h6><span className='bold'>Car Dealers:</span> &nbsp;<span className='text-primary'> {item.product[0].agencyName}</span> </h6>
                                                ...
                                                <div className="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                                    ...
                                                    <div className='row mt-5 mt-4'>
                                                        <div className="col">
                                                            <strong>Deal Status: </strong>&nbsp; <span style={{ color: `${item.order_status === 'Pending' ? 'blue' : 'green'}` }} className=' bold fs-5'>{item.order_status.toUpperCase()}</span>
                                                        </div>
                                                    </div>
