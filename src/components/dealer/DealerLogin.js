...
export default function DealersLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/auth/dealer/login`, {
      method: 'POST',
      headers: {
        ...
        <div className="row">
          ...
          <div className=" col-lg-6 col-sm-12 mini-container">
            ...
            <form className='form-group mt-4'>
              ...
              <p className='mt-3'>Don't have a dealers account<Link to='/agency-register'><small className='text-danger bold'> Register Dealers</small></Link></p>
